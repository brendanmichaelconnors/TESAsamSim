...
#             dirName="example", nTrials=10, makeSubDirs=FALSE, random=FALSE)}
...
# Can just get file and start from here
dlm_out_all_combo <- readr::read_csv(here::here("outputs/diagnostics",   "model_estimates_all_combos.csv"))
